class FillMontenegroRegionsByCity < ActiveRecord::Migration[5.1]
  def change
    sql = ActiveRecord::Base.connection()
    update_values = Set.new
    updated_count = 0

    properties = Property.where('NOT city_id IS NULL AND region_id IS NULL AND country_id = 3194884')
