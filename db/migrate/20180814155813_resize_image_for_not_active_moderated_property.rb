class ResizeImageForNotActiveModeratedProperty < ActiveRecord::Migration[5.2]
  def change
    properties = Property.where("properties.is_active = ? AND properties.moderated = ?", false, true)
