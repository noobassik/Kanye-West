class CreatePages < ActiveRecord::Migration[5.2]
  def change
    ...
    Page.create!(slug: 'terms',
                 h1_ru: 'Соглашение об обработке персональных данных',
                 h1_en: 'Personal Data Processing Agreement',
                 title_ru: 'Соглашение об обработке персональных данных',
                 title_en: 'Personal Data Processing Agreement',
                 description_ru: 'Термины, применяемые в настоящем Соглашении:
Сайт – это совокупность текстов, графических элементов, дизайна, изображений, программного кода, фото- и видеоматериалов и иных результатов интеллектуальной деятельности, содержащихся в сети Интернет под доменным именем https://propimo.com.
Администрация Сайта – сотрудники Общества с ограниченной ответственностью «Смарт Трэвел Солюшнс», обладающее правами администрирования Сайта.
...
Настоящим в соответствии с Федеральным законом №152-ФЗ «О персональных данных» от 27.07.2006 года Пользователь подтверждает свое согласие на обработку Обществом с ограниченной ответственностью «ПРОПИМО» персональных данных: сбор, систематизацию, накопление, хранение, уточнение (обновление, изменение), использование, передачу, блокирование, обезличивание, уничтожение исключительно в целях оказания Пользователю услуг по предложению объектов недвижимости.
Администрация Сайта гарантирует конфиденциальность получаемой информации. Обработка персональных данных осуществляется в целях эффективного исполнения обязательств, принятых Администрацией сайта в качестве обязательных к исполнению перед Пользователем.
Настоящим особо оговаривается, что в случае необходимости предоставления персональных данных Пользователя собственнику объекта недвижимости либо иному другому лицу, заинтересованному в продаже объекта недвижимости, Пользователь даёт согласие на передачу своих персональных данных.
Настоящее согласие распространяется на следующие персональные данные Пользователя: фамилия, имя и отчество, адрес электронной почты, контактный телефон.
Принимая условия настоящего соглашения, Пользователь соглашается с получением рекламных рассылок от Администрации Сайта по телефону (в формате sms-сообщений и звонков) и по электронной почте. Пользователь вправе в любой момент отказаться от получения рекламных рассылок, путём направления письменного уведомления на электронную почту support@propimo.com.
Срок действия согласия является неограниченным, однако, Пользователь вправе в любой момент отозвать настоящее согласие, путём направления письменного уведомления на адрес: 119072, г Москва, Берсеневский переулок, д.5 стр.1, в ООО «Смарт Трэвел Солюшнс», с пометкой «отзыв согласия на обработку персональных данных». Обращаем внимание, что отзыв согласия Пользователя на обработку персональных данных влечёт за собой удаление учётной записи Пользователя с Сайта, а также уничтожение записей, содержащих персональные данные Пользователя, в системах обработки персональных данных ООО «Смарт Трэвел Солюшнс».',
                 description_en: 'Terms used in this Agreement:
A site is a collection of texts, graphic elements, design, images, program code, photo and video materials and results of intellectual activity used on the Internet under the domain name https://propimo.com.
Site Administration - employees of Smart Travel Solutions Limited Liability Company, which has the rights to administer the Site.
User agreement, regardless of the fact of registration and authorization procedures.
AGREEMENT ABOUT PROCESSING PERSONAL DATA
This document in accordance with Federal Law No. 152-ФЗ “On Personal Data” dated July 27, 2006 gives the right to consent to the processing of personal data in the PROPIMO public data: collection, systematization, accumulation, storage, clarification (updating, changing) use, transfer, blocking, depersonalization, destruction
The Site Administration guarantees the confidentiality of the information received. The processing of personal data is carried out in the order of mandatory performance of obligations.
It is hereby specifically required that, if it is necessary to provide personal data, users can participate in the sale of real estate.
This consent applies to the following personal data.
The user agrees to receive advertising mailings from the administration of the Site by phone (in the format of SMS messages and calls) and by e-mail. The user has the right at any time to refuse to receive promotional mailings, written notifications by e-mail support@propimo.com.
The validity of the consent is unlimited, however, the user has the right to revoke this consent at any time by sending a written notice to the address: 119072, Moscow, Bersenevsky Lane, 5 bldg. 1, in LLC Smart Travel Solutions, with the note “Revocation of consent to the processing of personal data”. Attention is drawn to the fact that the review must be provided in the form of personal data, as well as destroyed records on the Internet, as well as in the personal data processing system of Smart Travel Solutions LLC.',
                 meta_description_ru: '',
                 meta_description_en: '')



    Page.create!(slug: 'privacy',
                 h1_ru: 'Политика в отношении обработки персональных данных propimo.com',
                 h1_en: 'Propimo.com privacy policy',
                 title_ru: 'Политика в отношении обработки персональных данных propimo.com',
                 title_en: 'Propimo.com privacy policy',
                 description_ru: 'ПОЛИТИКА ООО «Смарт Трэвел Солюшнс» В ОТНОШЕНИИ ОБРАБОТКИ ПЕРСОНАЛЬНЫХ ДАННЫХ
1. ОБЩИЕ ПОЛОЖЕНИЯ
...
Настоящая Политика определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных в ООО «Смарт Трэвел Солюшнс» (далее – Оператор) с целью защиты прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.
...
Субъектами, персональные данные которых обрабатываются в ООО «Смарт Трэвел Солюшнс» с использованием средств автоматизации или без использования таковых, являются:
- кандидаты на работу Оператору;
...
- абоненты сайта ООО «Смарт Трэвел Солюшнс» в сети Интернет;
- иные лица, обработка ПД которых необходима Оператору для осуществления целей, указанных в настоящей Политике.
...
ООО «Смарт Трэвел Солюшнс» обязано опубликовать или иным образом обеспечить неограниченный доступ к настоящей Политике обработки персональных данных в соответствии с ч. 2 ст. 18.1 ФЗ «О персональных данных».
...
Информационное окно, появляющийся на некоторых из наших веб-сайтов, будет запрашивать ваше согласие на сбор cookies. Для поддержания функционала сайта может потребоваться и второй вид cookies, именуемый «пользовательские cookies». Использование информационного баннера не приводит к блокировке этих cookies. Выбранный вами элемент будет сохранен в cookie-файле и действителен в течение 90 дней. Если вы захотите аннулировать его, вы можете сделать это, удалив cookie-файлы в своем браузере.
...
ООО «Смарт Трэвел Солюшнс» использует интернет-сервис Google Analytics. Подробную информацию об использовании Google Analytics вы можете найти здесь: http://www.google.com/analytics/learn/privacy.html
...
Сроки обработки (хранения) персональных данных определяются в соответствии со сроком действия договора с субъектом персональных данных, сроками исковой давности, а также иными сроками, установленными законодательством РФ и документами Оператора.
Персональные данные, срок обработки (хранения) которых истек, должны быть уничтожены, если иное не предусмотрено федеральным законом или нормативными документами Оператора.
Хранение персональных данных после истечения срока хранения допускается только после их обезличивания.
...
Работники Оператора, виновные в нарушении норм, регулирующих обработку и защиту персональных данных, несут материальную, дисциплинарную, административную, гражданско-правовую или уголовную ответственность в порядке, установленном федеральными законами.',
                 description_en: "POLICY OF Smart Travel Solutions LLC WITH RESPECT TO PERSONAL DATA PROCESSING
...
This Policy defines the procedure for processing personal data and measures to ensure the security of personal data at Smart Travel Solutions LLC (hereinafter referred to as the Operator) in order to protect the rights and freedoms of a person and citizen in the processing of his personal data, including the protection of privacy rights , personal and family secrets.
...
The subjects, the personal data of which are processed in LLC Smart Travel Solutions with or without automation, are:
...
Smart Travel Solutions LLC website subscribers on the Internet;
...
Smart Travel Solutions LLC is obliged to publish or otherwise provide unlimited access to this Personal Data Processing Policy in accordance with Part 2 of Art. 18.1 of the Federal Law \"On Personal Data\".
...
- the availability of written consent (including using the hardware of the site of Smart Travel Solutions LLC on the Internet) of the personal data subject to the cross-border transfer of his personal data;
- execution of a contract to which the subject of personal data is a party.
2.9. Automatic collection of personal information
In some cases, Smart Travel Solutions LLC uses cookies, web beacons and other technologies to automatically collect certain types of information when you visit propimo.com online or in the process of exchanging electronic messages with you. The collection of such information allows us to preserve the individual settings and parameters of online visitors, improve the functional characteristics of the website, make them more convenient for users and, in general, increase their efficiency, as well as evaluate the productivity of our marketing activities.
2.9.1. IP addresses
...
Smart Travel Solutions LLC uses the Google Analytics Internet service. You can find more information about using Google Analytics here: http://www.google.com/analytics/learn/privacy.html
To provide website visitors with more choices regarding the collection of their Google Analytics data, Google has developed the optional Google Analytics Opt-out Browser Add-on. An additional browser is linked to Google Analytics JavaScript (ga.js) so that website visits aren’t reported to Google Analytics. The optional Google Analytics browser does not prevent the information from being sent to the website itself or to other web analytics services.
...
Smart Travel Solutions LLC uses these web beacons in strict accordance with applicable law.
Smart Travel Solutions LLC or service provider organizations may use web beacons to monitor the performance of third-party websites that provide us with recruitment or marketing services, or to collect aggregated statistics about online visitors to the site and cookie management.
...
Smart Travel Solutions LLC may collect and use information about the geographical location of your computer or mobile device. The purpose of collecting this data is to provide you with information about services in your area that might be of interest to you and improve the products and services it offers.
