class Property::AutoNaming::Bungalow < BasicPresenter
  ...
  def prefix
    ...
    #   if self.area < 100
    #     I18n.t('property_chunks.prefix.masculine.cozy')
    #   elsif self.area >= 100 && self.area < 200
    #     I18n.t('property_chunks.prefix.masculine.spacious')
    #   elsif self.area >= 200
    #     I18n.t('property_chunks.prefix.masculine.fabulous')
    #   end
    # else
    ''
    # end
